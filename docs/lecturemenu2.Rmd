...
* <a href="./Data/teens_cell_phone_focus_simulated.csv">Teen cell-phone survey</a> &mdash; 743 responses (Figure 1 below).
* <a href="./Data/old_faithful.csv">Old Faithful eruptions</a> &mdash; 272 eruptions, duration and waiting time.
* <a href="./Data/carsdata.csv">MPG and engine cylinders</a> &mdash; 32 car models, used for the dot plot examples in class.
...
<a href="./Data/old_faithful.csv">Download the Old Faithful data</a> (all 272 eruptions).
...
In class we build these plots from the MPG and engine-cylinder data for 32 car models: <a href="./Data/carsdata.csv">download it here</a>.
