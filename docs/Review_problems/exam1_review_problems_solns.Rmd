...
${\bf (1)}$ For each statistic, indicate whether it is resistant or not resistant to outliers:
<ol type="a">
...
<ol type="a">
  ...
  <li>What is your height in inches?</li>
...
tbl = cbind.data.frame(Epoch = names(cts), Frequency = cts)
...
<li>Use the frequency table from part b.) to construct a bar plot of the variable "Epoch"</li>
...
<li>What proportion of the observations in the sample are from the epoch "cAD150"?
<span style="color: red;">$\hat{p}_{cAD150} = 5/10 = 0.5$</span>
</li>
...
<br>
${\bf (4)}$
Again, consider the 10 observations of measurements made on Egyptian skulls from five epochs given in problem $\bf (3)$. Answer parts (a) - (c)
<ol type="a">
  <li>Construct a histogram for the variable $nh$ (nasal height) using the following intervals: $48 \leq X \leq 50$, $50< X \leq 52$, $52< X\leq 54$, and $54< X\leq 56$. Start by filling in the frequency table below</li>
...
tbl = cbind.data.frame(Interval = c('$48 \\leq X \\leq 50$','$50< X \\leq 52$', '$52< X \\leq 54$', '$54< X \\leq 56$'), Frequency = cts)
...
```
<li>Using the histogram above, what proportion of the skulls have a nasal height less than or equal to 54 millimeters? <span style="color: red;">$\hat{p} = \frac{4+1+3}{10} = 0.8$</span></li>
...
<ol type="a">
  ...
  <li>What type of variable is "Circumference"? <span style="color: red;">quantitative continuous</span></li>
...
#Unlike the problems page, nothing is blanked out here - every cell is filled in.
