...
<li>What proportion of the observations in the sample are from the epoch "cAD150"?</li>
...
tbl = cbind.data.frame(Interval = c('$48 \\leq X \\leq 50$','$50< X \\leq 52$', '$52< X \\leq 54$', '$54< X \\leq 56$'), Frequency = rep("",4))
...
```
<li>Using the histogram above, what proportion of the skulls have a nasal height less than or equal to 54 millimeters?</li>
...
#sort() is essential here: cts/RF/CRF below come from summary(as.factor(magr)),
#which is ordered by factor level (i.e. sorted). unique() returns values in order
#of first appearance, which would pair each magnitude with another magnitude's counts.
