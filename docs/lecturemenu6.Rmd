...
<!--
  ...
  The 2024 "Sources of Bias In Surveys", "More Complicated Sampling Designs"
  and "Ethical studies" sections that used to open this page were replaced by
  the Lecture 8, 9 and 10 write-up in the Weeks 4-5 notes (Sept 14, 21 and 23). Do not
  re-add them here. The rest of this page is still 2024 material awaiting its
  Fall 2026 revision.

  Week 6 now opens with identifying outliers, margin of error and statistical
  significance on Monday Sept 28, which slipped out of Week 5 when Lecture 9 ran
  short; probability then starts Wednesday Sept 30. See Course_Schedule.Rmd.
-->
